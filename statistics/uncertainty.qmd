...
It is tempting to think uncertainty means only that we do not know enough. But statistics teaches something subtler:
...
So uncertainty is more than emptiness. Not just a hole in our understandment.  
Emptiness has shape, source, and consequence. The hole has edges. The shape of the hole is revealing a universe inside. 
...
There can be a horizon where knowledge is uncertain, time can hide the signal into noise, or a veil can filter information out. 
